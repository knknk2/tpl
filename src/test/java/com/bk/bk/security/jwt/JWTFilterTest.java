...
public class JWTFilterTest {
  ...
  public void setup() {
    ...
    ReflectionTestUtils.setField(tokenProvider, "key", Keys.hmacShaKeyFor(Decoders.BASE64
  ...
  public void testJWTFilter() throws Exception {
    SamAuthenticationToken authentication = new SamAuthenticationToken("test-user",
        "test-password", Collections.singletonList(new SimpleGrantedAuthority(AuthoritiesConstants.USER)), 1L);
